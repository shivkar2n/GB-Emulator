...
func (s *CPU) ADDSPE8() { // reg[SP] = reg[SP] + e8
	op := int(int8(s.Mem.Read(s.GetReg16Val("PC") + 1)))
...
func (s *CPU) LDN16SP() {
	...
	s.Mem.Write(s.GetReg16Val("SP")&0xFF, int(uint16(addr))) // M[n16] = reg[SP]
	s.Mem.Write(s.GetReg16Val("SP")>>8, int(uint16(addr+1))) // M[n16+1] = reg[SP] >> 8
	s.SetReg16Val("PC", s.GetReg16Val("PC")+3)
	s.SetClockTime(20, 5)
}
...
func (s *CPU) POPFA() { // POP reg[AF] from Stack
	s.SetReg8Val("F", int(s.Mem.Read(s.GetReg16Val("SP"))&0xF0))
	s.SetReg16Val("SP", int(int16(s.GetReg16Val("SP")+1)))
	s.SetReg8Val("A", int(s.Mem.Read(s.GetReg16Val("SP"))))
	s.SetReg16Val("SP", int(int16(s.GetReg16Val("SP")+1)))
	s.SetReg16Val("PC", s.GetReg16Val("PC")+1)
	s.SetClockTime(12, 3)
}
...
func (s *CPU) POPR16(reg string) { // POP reg[] from Stack
	x := int(s.Mem.Read(s.GetReg16Val("SP")))
	s.SetReg16Val("SP", s.GetReg16Val("SP")+1)
	y := int(s.Mem.Read(s.GetReg16Val("SP"))) << 8
	s.SetReg16Val("SP", s.GetReg16Val("SP")+1)
...
func (s *CPU) PUSHFA() { // PUSH reg[AF] from Stack
	s.SetReg16Val("SP", int(int16(s.GetReg16Val("SP")-1)))
	s.Mem.Write(s.GetReg8Val("A"), s.GetReg16Val("SP"))
	s.SetReg16Val("SP", int(int16(s.GetReg16Val("SP")-1)))
	s.Mem.Write((s.GetFlag("Z")<<7)|(s.GetFlag("N")<<6)|(s.GetFlag("H")<<5)|(s.GetFlag("C")<<4), s.GetReg16Val("SP"))
	s.SetReg16Val("PC", s.GetReg16Val("PC")+1)
	s.SetClockTime(16, 4)
}
...
func (s *CPU) PUSHR16(reg string) { // PUSH reg[] from Stack
	s.SetReg16Val("SP", int(int16(s.GetReg16Val("SP")-1)))
	s.Mem.Write((s.GetReg16Val(reg)&0xFF00)>>8, s.GetReg16Val("SP"))
	s.SetReg16Val("SP", int(int16(s.GetReg16Val("SP")-1)))
	s.Mem.Write(s.GetReg16Val(reg)&0xFF, s.GetReg16Val("SP"))
	s.SetReg16Val("PC", s.GetReg16Val("PC")+1)
	s.SetClockTime(16, 4)
}
...
func (s *CPU) PUSHN16(op int) { // PUSH N16 from Stack
	s.SetReg16Val("SP", int(int16(s.GetReg16Val("SP")-1)))
	s.Mem.Write((op&0xFF00)>>8, s.GetReg16Val("SP"))
	s.SetReg16Val("SP", int(int16(s.GetReg16Val("SP")-1)))
	s.Mem.Write(op&0xFF, s.GetReg16Val("SP"))
}
